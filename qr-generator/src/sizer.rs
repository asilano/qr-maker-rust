...
impl Sizer {
    ...
    pub(crate) fn error_correction_shape(
        ...
        match qr_type {
            ...
            QRSymbolTypes::QRCode => match (version, correction) {
                ...
                (4, CorrectionLevels::L) => vec![(100, 80, 1)],
                (4, CorrectionLevels::M) => vec![(50, 32, 2)],
                (4, CorrectionLevels::Q) => vec![(50, 24, 2)],
                (4, CorrectionLevels::H) => vec![(25, 9, 4)],
                (5, CorrectionLevels::L) => vec![(134, 108, 1)],
                (5, CorrectionLevels::M) => vec![(67, 43, 2)],
                (5, CorrectionLevels::Q) => vec![(33, 15, 2), (34, 16, 2)],
                (5, CorrectionLevels::H) => vec![(33, 11, 2), (34, 12, 2)],
                (6, CorrectionLevels::L) => vec![(86, 68, 2)],
                (6, CorrectionLevels::M) => vec![(43, 27, 4)],
                (6, CorrectionLevels::Q) => vec![(43, 19, 4)],
                (6, CorrectionLevels::H) => vec![(43, 15, 4)],
                (7, CorrectionLevels::L) => vec![(98, 78, 2)],
                (7, CorrectionLevels::M) => vec![(49, 31, 4)],
                (7, CorrectionLevels::Q) => vec![(32, 14, 2), (33, 15, 4)],
                (7, CorrectionLevels::H) => vec![(39, 13, 4), (40, 14, 1)],
                (8, CorrectionLevels::L) => vec![(121, 97, 2)],
                (8, CorrectionLevels::M) => vec![(60, 38, 2), (61, 39, 2)],
                (8, CorrectionLevels::Q) => vec![(40, 18, 4), (41, 19, 2)],
                (8, CorrectionLevels::H) => vec![(40, 14, 4), (41, 15, 2)],
                (9, CorrectionLevels::L) => vec![(146, 116, 2)],
                (9, CorrectionLevels::M) => vec![(58, 36, 3), (59, 37, 2)],
                (9, CorrectionLevels::Q) => vec![(36, 16, 4), (37, 17, 4)],
                (9, CorrectionLevels::H) => vec![(36, 12, 4), (37, 13, 4)],
                (10, CorrectionLevels::L) => vec![(86, 68, 2), (87, 69, 2)],
                (10, CorrectionLevels::M) => vec![(69, 43, 4), (70, 44, 1)],
                (10, CorrectionLevels::Q) => vec![(43, 19, 6), (44, 20, 2)],
                (10, CorrectionLevels::H) => vec![(43, 15, 6), (44, 16, 2)],
                (11, CorrectionLevels::L) => vec![(101, 81, 4)],
                (11, CorrectionLevels::M) => vec![(80, 50, 1), (81, 51, 4)],
                (11, CorrectionLevels::Q) => vec![(50, 22, 4), (51, 23, 4)],
                (11, CorrectionLevels::H) => vec![(36, 12, 3), (37, 13, 8)],
                (12, CorrectionLevels::L) => vec![(116, 92, 2), (117, 93, 2)],
                (12, CorrectionLevels::M) => vec![(58, 36, 6), (59, 37, 2)],
                (12, CorrectionLevels::Q) => vec![(46, 20, 4), (47, 21, 6)],
                (12, CorrectionLevels::H) => vec![(42, 14, 7), (43, 15, 4)],
                (13, CorrectionLevels::L) => vec![(133, 107, 4)],
                (13, CorrectionLevels::M) => vec![(59, 37, 8), (60, 38, 1)],
                (13, CorrectionLevels::Q) => vec![(44, 20, 8), (45, 21, 4)],
                (13, CorrectionLevels::H) => vec![(33, 11, 12), (34, 12, 4)],
                (14, CorrectionLevels::L) => vec![(145, 115, 3), (146, 116, 1)],
                (14, CorrectionLevels::M) => vec![(64, 40, 4), (65, 41, 5)],
                (14, CorrectionLevels::Q) => vec![(36, 16, 11), (37, 17, 5)],
                (14, CorrectionLevels::H) => vec![(36, 12, 11), (37, 13, 5)],
                (15, CorrectionLevels::L) => vec![(109, 87, 5), (110, 88, 1)],
                (15, CorrectionLevels::M) => vec![(65, 41, 5), (66, 42, 5)],
                (15, CorrectionLevels::Q) => vec![(54, 24, 5), (55, 25, 7)],
                (15, CorrectionLevels::H) => vec![(36, 12, 11), (37, 13, 7)],
                (16, CorrectionLevels::L) => vec![(122, 98, 5), (123, 99, 1)],
                (16, CorrectionLevels::M) => vec![(73, 45, 7), (74, 46, 3)],
                (16, CorrectionLevels::Q) => vec![(43, 19, 15), (44, 20, 2)],
                (16, CorrectionLevels::H) => vec![(45, 15, 3), (46, 16, 13)],
                (17, CorrectionLevels::L) => vec![(135, 107, 1), (136, 108, 5)],
                (17, CorrectionLevels::M) => vec![(74, 46, 10), (75, 47, 1)],
                (17, CorrectionLevels::Q) => vec![(50, 22, 1), (51, 23, 15)],
                (17, CorrectionLevels::H) => vec![(42, 14, 2), (43, 15, 17)],
                (18, CorrectionLevels::L) => vec![(150, 120, 5), (151, 121, 1)],
                (18, CorrectionLevels::M) => vec![(69, 43, 9), (70, 44, 4)],
                (18, CorrectionLevels::Q) => vec![(50, 22, 17), (51, 23, 1)],
                (18, CorrectionLevels::H) => vec![(42, 14, 2), (43, 15, 19)],
                (19, CorrectionLevels::L) => vec![(141, 113, 3), (142, 114, 4)],
                (19, CorrectionLevels::M) => vec![(70, 44, 3), (71, 45, 11)],
                (19, CorrectionLevels::Q) => vec![(47, 21, 17), (48, 22, 4)],
                (19, CorrectionLevels::H) => vec![(39, 13, 9), (40, 14, 16)],
                (20, CorrectionLevels::L) => vec![(135, 107, 3), (136, 108, 5)],
                (20, CorrectionLevels::M) => vec![(67, 41, 3), (68, 42, 13)],
                (20, CorrectionLevels::Q) => vec![(54, 24, 15), (55, 25, 5)],
                (20, CorrectionLevels::H) => vec![(43, 15, 15), (44, 16, 10)],
                (21, CorrectionLevels::L) => vec![(144, 116, 4), (145, 117, 4)],
                (21, CorrectionLevels::M) => vec![(68, 42, 17)],
                (21, CorrectionLevels::Q) => vec![(50, 22, 17), (51, 23, 6)],
                (21, CorrectionLevels::H) => vec![(46, 16, 19), (47, 17, 6)],
                (22, CorrectionLevels::L) => vec![(139, 111, 2), (140, 112, 7)],
                (22, CorrectionLevels::M) => vec![(74, 46, 17)],
                (22, CorrectionLevels::Q) => vec![(54, 24, 7), (55, 25, 16)],
                (22, CorrectionLevels::H) => vec![(37, 13, 34)],
                (23, CorrectionLevels::L) => vec![(151, 121, 4), (152, 122, 5)],
                (23, CorrectionLevels::M) => vec![(75, 47, 4), (76, 48, 14)],
                (23, CorrectionLevels::Q) => vec![(54, 24, 11), (55, 25, 14)],
                (23, CorrectionLevels::H) => vec![(45, 15, 16), (46, 16, 14)],
                (24, CorrectionLevels::L) => vec![(147, 117, 6), (148, 118, 4)],
                (24, CorrectionLevels::M) => vec![(73, 45, 6), (74, 46, 14)],
                (24, CorrectionLevels::Q) => vec![(54, 24, 11), (55, 25, 16)],
                (24, CorrectionLevels::H) => vec![(46, 16, 30), (47, 17, 2)],
                (25, CorrectionLevels::L) => vec![(132, 106, 8), (133, 107, 4)],
                (25, CorrectionLevels::M) => vec![(75, 47, 8), (76, 48, 13)],
                (25, CorrectionLevels::Q) => vec![(54, 24, 7), (55, 25, 22)],
                (25, CorrectionLevels::H) => vec![(45, 15, 22), (46, 16, 13)],
                (26, CorrectionLevels::L) => vec![(142, 114, 10), (143, 115, 2)],
                (26, CorrectionLevels::M) => vec![(74, 46, 19), (75, 47, 4)],
                (26, CorrectionLevels::Q) => vec![(50, 22, 28), (51, 23, 6)],
                (26, CorrectionLevels::H) => vec![(46, 16, 33), (47, 17, 4)],
                (27, CorrectionLevels::L) => vec![(152, 122, 8), (153, 123, 4)],
                (27, CorrectionLevels::M) => vec![(73, 45, 22), (74, 46, 3)],
                (27, CorrectionLevels::Q) => vec![(53, 23, 8), (54, 24, 26)],
                (27, CorrectionLevels::H) => vec![(45, 15, 12), (46, 16, 28)],
                (28, CorrectionLevels::L) => vec![(147, 117, 3), (148, 118, 10)],
                (28, CorrectionLevels::M) => vec![(73, 45, 3), (74, 46, 23)],
                (28, CorrectionLevels::Q) => vec![(54, 24, 4), (55, 25, 31)],
                (28, CorrectionLevels::H) => vec![(45, 15, 11), (46, 16, 31)],
                (29, CorrectionLevels::L) => vec![(146, 116, 7), (147, 117, 7)],
                (29, CorrectionLevels::M) => vec![(73, 45, 21), (74, 46, 7)],
                (29, CorrectionLevels::Q) => vec![(53, 23, 1), (54, 24, 37)],
                (29, CorrectionLevels::H) => vec![(45, 15, 19), (46, 16, 26)],
                (30, CorrectionLevels::L) => vec![(145, 115, 5), (146, 116, 10)],
                (30, CorrectionLevels::M) => vec![(75, 47, 19), (76, 48, 10)],
                (30, CorrectionLevels::Q) => vec![(54, 24, 15), (55, 25, 25)],
                (30, CorrectionLevels::H) => vec![(45, 15, 23), (46, 16, 25)],
                (31, CorrectionLevels::L) => vec![(145, 115, 13), (146, 116, 3)],
                (31, CorrectionLevels::M) => vec![(74, 46, 2), (75, 47, 29)],
                (31, CorrectionLevels::Q) => vec![(54, 24, 42), (55, 25, 1)],
                (31, CorrectionLevels::H) => vec![(45, 15, 23), (46, 16, 28)],
                (32, CorrectionLevels::L) => vec![(145, 115, 17)],
                (32, CorrectionLevels::M) => vec![(74, 46, 10), (75, 47, 23)],
                (32, CorrectionLevels::Q) => vec![(54, 24, 10), (55, 25, 35)],
                (32, CorrectionLevels::H) => vec![(45, 15, 19), (46, 16, 35)],
                (33, CorrectionLevels::L) => vec![(145, 115, 17), (146, 116, 1)],
                (33, CorrectionLevels::M) => vec![(74, 46, 14), (75, 47, 21)],
                (33, CorrectionLevels::Q) => vec![(54, 24, 29), (55, 25, 19)],
                (33, CorrectionLevels::H) => vec![(45, 15, 11), (46, 16, 46)],
                (34, CorrectionLevels::L) => vec![(145, 115, 13), (146, 116, 6)],
                (34, CorrectionLevels::M) => vec![(74, 46, 14), (75, 47, 23)],
                (34, CorrectionLevels::Q) => vec![(54, 24, 44), (55, 25, 7)],
                (34, CorrectionLevels::H) => vec![(46, 16, 59), (47, 17, 1)],
                (35, CorrectionLevels::L) => vec![(151, 121, 12), (152, 122, 7)],
                (35, CorrectionLevels::M) => vec![(75, 47, 12), (76, 48, 26)],
                (35, CorrectionLevels::Q) => vec![(54, 24, 39), (55, 25, 14)],
                (35, CorrectionLevels::H) => vec![(45, 15, 22), (46, 16, 41)],
                (36, CorrectionLevels::L) => vec![(151, 121, 6), (152, 122, 14)],
                (36, CorrectionLevels::M) => vec![(75, 47, 6), (76, 48, 34)],
                (36, CorrectionLevels::Q) => vec![(54, 24, 46), (55, 25, 10)],
                (36, CorrectionLevels::H) => vec![(45, 15, 2), (46, 16, 64)],
                (37, CorrectionLevels::L) => vec![(152, 122, 17), (153, 123, 4)],
                (37, CorrectionLevels::M) => vec![(74, 46, 29), (75, 47, 14)],
                (37, CorrectionLevels::Q) => vec![(54, 24, 49), (55, 25, 10)],
                (37, CorrectionLevels::H) => vec![(45, 15, 24), (46, 16, 46)],
                (38, CorrectionLevels::L) => vec![(152, 122, 4), (153, 123, 18)],
                (38, CorrectionLevels::M) => vec![(74, 46, 13), (75, 47, 32)],
                (38, CorrectionLevels::Q) => vec![(54, 24, 48), (55, 25, 14)],
                (38, CorrectionLevels::H) => vec![(45, 15, 42), (46, 16, 32)],
                (39, CorrectionLevels::L) => vec![(147, 117, 20), (148, 118, 4)],
                (39, CorrectionLevels::M) => vec![(75, 47, 40), (76, 48, 7)],
                (39, CorrectionLevels::Q) => vec![(54, 24, 43), (55, 25, 22)],
                (39, CorrectionLevels::H) => vec![(45, 15, 10), (46, 16, 67)],
                (40, CorrectionLevels::L) => vec![(148, 118, 19), (149, 119, 6)],
                (40, CorrectionLevels::M) => vec![(75, 47, 18), (76, 48, 31)],
                (40, CorrectionLevels::Q) => vec![(54, 24, 34), (55, 25, 34)],
                (40, CorrectionLevels::H) => vec![(45, 15, 20), (46, 16, 61)],
                _ => unreachable!(),
            },
        }
    }
    ...
    fn calculate_standard_alphanumeric_version(
        ...
        match (correction, data.len()) {
            ...
            _ => Err(EncodingError::new(
                "Too much data for AlphaNumeric mode and error correction level",
            )),
        }
    }
    ...
    fn calculate_standard_byte_version(
        ...
        match (correction, data.len()) {
            ...
            _ => Err(EncodingError::new(
                "Too much data for Byte mode and error correction level",
            )),
        }
    }
